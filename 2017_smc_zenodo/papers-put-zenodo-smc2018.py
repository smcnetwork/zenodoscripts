...
# the IDs to be skipped in upload: (none such here)
#~ skip_ids = [ "smc:2004:001" ]
skip_ids = [ ]

# SO:107705; unbuffer for both python 2 and 3; to have this work: python3 papers-put-zenodo-smc2018.py 2>&1 | tee _put_2018.log
buf_arg = 0
if sys.version_info[0] == 3:
...
# not anymore, now only a single subdir:
subdirs = [ "SMC Conference 2018" ]
